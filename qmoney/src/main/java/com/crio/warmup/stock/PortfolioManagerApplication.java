...
public class PortfolioManagerApplication {
  ...
  // public static List<String> mainReadFile(String[] args) throws IOException,
  // URISyntaxException {
  // // return Collections.emptyList();
  // return (List<String>) resolveFileFromResources("trades.json");
  // }
  ...
  private static void printJsonObject(Object object) throws IOException {
    ...
    PortfolioManagerApplication obj = mapper.readValue(new File("qmoney/src/main/resources/trades.json"),
        PortfolioManagerApplication.class);
  ...
  public static List<String> debugOutputs() {
    ...
    String resultOfResolveFilePathArgs0 = "/home/crio-user/workspace/nilesh-kumarsikri-ME_QMONEY/qmoney/bin/main/trades.json";
